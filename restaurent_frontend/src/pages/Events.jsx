...
const events = [
    {
      ...
      imageUrl: '../src/assets/events/Image (8).png',
    },
    {
      date: 'FEB 6, 2023',
      title: 'Live Music Night',
      description: 'Enjoy live performances from local artists.',
      imageUrl: '../src/assets/events/960x0-1 2.png',
    },
    {
        date: 'FEB 6, 2023',
        title: 'Live Music Night',
        description: 'Enjoy live performances from local artists.',
        imageUrl: '../src/assets/events/Image (7).png',
      },
      {
        date: 'FEB 7, 2023',
        title: 'Art Exhibition',
        description: 'Discover local art and creativity.',
        imageUrl: '../src/assets/events/960x0-1 1.png',
      },
      {
        date: 'FEB 8, 2023',
        title: 'Gourmet Dinner',
        description: 'Enjoy an exclusive gourmet dinner.',
        imageUrl: '../src/assets/events/Image (7).png',
      },
  ];
...
const Events = () => {
  ...
  return (
    ...
    <div className="max-w-5xl mx-auto px-4">
      <h1 className="text-3xl font-bold mb-4 text-center">Events & Location</h1>
